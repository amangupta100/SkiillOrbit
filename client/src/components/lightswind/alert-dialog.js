  ...
  return _jsx(AnimatePresence, {
    children:
      ...
      _jsx("div", {
        ref: ref,
        className: cn(
          "fixed inset-0 z-50 bg-gray-300/50 backdrop-blur-md",
          className
        ),
        ...props,
      }),
        ...
        _jsxs(AlertDialogPortal, {
          children: [
            ...
            _jsx(motion.div, {
              ...
              className: cn(
                "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-gray-300/50 backdrop-blur-md p-6 shadow-lg sm:rounded-lg",
                className
              ),
