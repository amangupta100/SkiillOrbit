    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx("h2", {
            className:
              "text-4xl mb-14 md:mb-0 sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-tr from-neutral-800 to-neutral-200 text-center dark:text-white",
            children: title,
          }),
          _jsx("p", {
      ...
      _jsx("div", {
        className:
          "relative lg:max-w-7xl md:max-w-5xl mx-auto sm:px-4 px-2 sm:pb-16 pb-0",
        children: _jsxs("div", {
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      _jsx(motion.div, {
                        ...
                        viewport: { once: false, margin: "-100px" },
                        style:
                          parallaxIntensity > 0 ? { y: yOffset } : undefined,
                        children: _jsx(Card, {
