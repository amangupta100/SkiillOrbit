        ...
        jobs.length > 0 && (
          <div className="flex flex-wrap gap-8 py-8">
            {jobs.map((job) => (
              <div
                key={job._id}
                className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm w-full mx-auto relative"
              >
                {/* Badge section */}
                ...
                <div className="flex flex-wrap justify-between gap-4 text-sm text-gray-600 mb-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">
                      ₹{" "}
                      {job.type === "Internship"
                        ? `${formatStipend(job.stipend.min)}k - ${formatStipend(
                            job.stipend.max
                          )}k`
                  ...
                  <div
                    className={`${job.type == "Internship" ? null : "hidden"}`}
                  >
                    <div
                ...
                <div className="mt-3">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    ...
                    <div className="flex justify-between w-full md:w-auto text-blue-600 font-medium text-sm md:text-base">
                      <span className="">
                        Apply by{" "}
                        {formatPreferredJoiningDate(job.preferredJoiningDate)}
                      </span>
