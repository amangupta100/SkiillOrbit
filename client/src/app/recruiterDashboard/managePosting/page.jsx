                ...
                <div className="absolute cursor-pointer top-0 right-1 bg-gray-100 border-[1.6px] border-zinc-200 rounded-full p-1 transform -translate-y-1/2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-40">
                      <DropdownMenuItem
                        onClick={() =>
                          router.push(`/recruiter/managePosting/${job._id}`)
                        }
                      >
                        View Details
                      </DropdownMenuItem>

                      <DropdownMenuItem onClick={() => setChangeStModal(true)}>
                        Change Status
                      </DropdownMenuItem>

                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          {/* ⚠️ Button bana lo taaki dropdown close ho aur dialog open ho */}
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete the posting and remove it from
                              your dashboard.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
