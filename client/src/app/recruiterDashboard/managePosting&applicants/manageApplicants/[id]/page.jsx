...
const PageContent = () => {
  ...
  return (
    <div className="md:p-6 p-4 space-y-6">
      ...
      <div className="border-[1.6px] border-zinc-200 rounded-lg w-fit p-2">
        <h1 className="text-[16px] font-semibold">{opporDet?.role}</h1>
      ...
      {loading ? (
        ...
        <div className="border-[1.6px] rounded-lg bg-zinc-100 border-zinc-200 ">
          <div className="bg-white rounded-lg py-2 mb-2 px-4 border-b-[1.6px] border-zinc-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={handleApplyToAll} disabled>
                    Apply To All
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
          ...
          <div className="">
            <h1 className="text-sm text-zinc-400 ml-3">
              {" "}
              Showing All {applicants.length} Applicants
            </h1>
                ...
                sortedApplicants.map(
                  (
                    ...
                    <div
                      ...
                      //   )
                      // }
                      className="border-[1.6px] lg:max-w-80 w-full flex items-center rounded-lg border-zinc-200 bg-white p-3 relative"
                    >
                      {/* Three-dot dropdown (top-right corner) */}
                      <div className="absolute -top-4 right-2 gap-3 flex items-center">
                        {appl.atsScore && (
                          <div className="border-[1.6px] bg-zinc-200 border-zinc-300 rounded-xl py-1 px-2">
                        ...
                        {appl.status === "shortlisted" && (
                          <div className="border-[1.6px] bg-green-300 text-white rounded-xl py-1 px-2">
                            <h1 className="text-sm ">ShortListed</h1>
                          </div>
                        )}

                        <div className="border-[1.6px] border-zinc-200 rounded-full bg-white cursor-pointer z-20">
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <button
                            ...
                            <DropdownMenuContent align="end" className="w-40">
                              <DropdownMenuItem
                                onClick={(e) => {
                                  e.stopPropagation();
                                  router.push(
                                    `/recruiterDashboard/managePosting&applicants/manageApplicants/${id}/aplId=${appl.user._id}`
                                  );
                                }}
                              >
                                View Profile
                                ...
                                onClick={async (e) => {
                                  ...
                                  try {
                                    const res = await API.post(
                                      `/recruiter/managePosting/shortlistApl`,
                                      {
                                        opporId: id,
                                        applId: appl._id,
                                      }
                              ...
                              >
                                {actionLoading.shortlistApl && (
                                  <ButtonLoader color="black" />
                                )}{" "}
                                <h1>Shortlist Applicant</h1>
                              </DropdownMenuItem>
